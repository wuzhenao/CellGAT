...
def get_cell_LR_embeddings(matrix,meta,nodes,interactions,total_embeddings_df,Omnipath_nodes,Omnipath_interactions,spatial=None):
    ...
    ident_interactions = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/intercell_Omnipath.csv",index_col=0)
    ...
    Omnipath_db = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/new_OmniPath_database.csv",index_col=0)
...
def make_nodes_interactions(matrix,input_meta=None):
    ...
    LR_nodes = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/OmniPath_nodes.csv",index_col=0)
    Omnipath_network = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/OmniPath_interactions.csv",index_col=0)
    LR_nodes.index = LR_nodes["Id"].tolist()
