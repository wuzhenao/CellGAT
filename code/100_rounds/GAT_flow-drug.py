...
class GAT(torch.nn.Module):
    def __init__(self,data,num_classes=3):
        ...
        self.conv1 = GATv2Conv(data.x.shape[1], self.hid, heads=self.in_head, dropout=0.6)
...
def get_Omnipath_embeddings(nodes,interactions):
    ...
    complexes = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/complexes.csv")
    ...
    pathways = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/kegg_pathways.csv",index_col=0)
    ...
    loader = model.loader(batch_size=2, shuffle=True, num_workers=0)
...
matrix = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/raw_data/Pre_Post/GSE150949/pc9_t0.csv",index_col=0)
...
matrix = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/raw_data/Pre_Post/GSE150949/pc9_t7_rep1.csv",index_col=0)
...
matrix = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/raw_data/Pre_Post/GSE150949/pc9_t7_rep2.csv",index_col=0)
...
Omnipath_database = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/intercell_Omnipath.csv",index_col=0)
Omnipath_database.columns = ["from","to","refernces"]
...
for i in range(100):
    if i % 10 == 0:
        print(i)
    new_day_0_list[i].drop_duplicates().head(1500).to_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_random_data/Pre_Post/Day0/Day0_{i+1}_random.csv") 
    new_rep_1_list[i].drop_duplicates().head(1500).to_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_random_data/Pre_Post/Day7_1/Rep1_{i+1}_random.csv")
    new_rep_2_list[i].drop_duplicates().head(1500).to_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_random_data/Pre_Post/Day7_2/Rep2_{i+1}_random.csv")
