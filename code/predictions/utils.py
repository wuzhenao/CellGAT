...
def get_Omnipath_embeddings(nodes,interactions,reproduce=None,save=None,lr=0.01):#0.01
    ...
    os.system(f"mkdir -p /home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_models/Mouse")
    torch.save(model,f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_models/Mouse/Omnipath.pt")
...
def get_cell_LR_embeddings(matrix,meta,nodes,interactions,total_embeddings_df,Omnipath_nodes,Omnipath_interactions,spatial=None,reproduce=None,save=None):
    ...
    ident_interactions = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/consensus_Omnipath.csv",index_col=0)
    ...
    # if reproduce is not None:
    #     print("Reproducing results from original paper - no training process")
    #     model = torch.load(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_models/Mouse/cell_LR.pt")
    # else:
    ...
    for epoch in range(100):
        ...
        optimizer.step()
    os.system(f"mkdir -p /home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_models/Mouse/")
    torch.save(model,f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_models/Mouse/cell_LR.pt")
    # 未进行第一次训练
    model = torch.load(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_models/Mouse/cell_LR.pt")
    ...
    Omnipath_db = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/Omnipath_database.csv",index_col=0)
...
def make_nodes_interactions(matrix,input_meta=None):
    ...
    LR_nodes = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/nodes.csv",index_col=0)
    Omnipath_network = pd.read_csv("/home/tjzhang01/wuzhenao/CellGATv2/data/LR_database/interactions.csv",index_col=0)
