...
nodes = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/nodes.csv",index_col=0)
interactions = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/interactions.csv",index_col=0)
matrix = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/matrix.csv",index_col=0)
meta = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/meta.csv",index_col=0)
LR_nodes = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/LR_nodes.csv",index_col=0)
Omnipath_network = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/Omnipath_network.csv",index_col=0)
...
os.system("mkdir -p {}".format(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Drosophila/"))
total_link_df.to_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Output/Drosophila/CCI.csv")
