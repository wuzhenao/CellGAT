...
nodes = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/nodes.csv",index_col=0)
interactions = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/interactions.csv",index_col=0)
matrix = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/matrix.csv",index_col=0)
meta = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/meta.csv",index_col=0)
LR_nodes = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/LR_nodes.csv",index_col=0)
Omnipath_network = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/Omnipath_network.csv",index_col=0)
...
os.system("mkdir -p {}".format(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/consensus_Mouse/"))
total_link_df.to_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Output/consensus_Mouse/CCI.csv")
