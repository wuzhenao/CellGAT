...
nodes = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/nodes.csv",index_col=0)
interactions = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/interactions.csv",index_col=0)
matrix = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/matrix.csv",index_col=0)
meta = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/meta.csv",index_col=0)
LR_nodes = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/LR_nodes.csv",index_col=0)
Omnipath_network = pd.read_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/Omnipath_network.csv",index_col=0)
...
os.system("mkdir -p {}".format(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Input/Cardiac_cells/FZ_GT_P19/"))
total_link_df.to_csv(f"/home/tjzhang01/wuzhenao/CellGATv2/data/CellGATv2_Output/Cardiac_cells/FZ_GT_P19/CCI.csv")
